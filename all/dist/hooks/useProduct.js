...
var useProduct = function useProduct(id) {
  ...
  var storeProduct = (0, _reactRedux.useSelector)(function (state) {
    return state.products.items.find(function (item) {
      return item.id === id;
    });
  });
  var _useState = (0, _react.useState)(storeProduct),
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            setLoading(true);
            _context.next = 5;
            return _firebase["default"].getSingleProduct(id);
          case 5:
            doc = _context.sent;
            if (doc.exists) {
