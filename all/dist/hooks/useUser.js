...
var useUser = function useUser() {
  ...
  var storeUser = (0, _reactRedux.useSelector)(function (state) {
    return state.auth.user;
  });
  var _useState = (0, _react.useState)(storeUser),
    _useState2 = _slicedToArray(_useState, 2),
    userData = _useState2[0],
    setUserData = _useState2[1]; // Cambia el nombre de 'user' a 'userData'
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _firebase["default"].getUserData(userId);
            case 5:
              _userData = _context.sent;
              if (_userData) {
                // Actualiza el estado local con los datos del usuario
                setUserData(_userData); // Cambia 'setUser' a 'setUserData'
                setLoading(false);
              } else {
