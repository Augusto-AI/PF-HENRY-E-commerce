...
var Firebase = /*#__PURE__*/_createClass(function Firebase() {
  ...
  _defineProperty(this, "signInWithGoogle", function () {
    return _this.auth.signInWithPopup(new _app["default"].auth.GoogleAuthProvider());
  });
  _defineProperty(this, "signInWithFacebook", function () {
    return _this.auth.signInWithPopup(new _app["default"].auth.FacebookAuthProvider());
  });
  _defineProperty(this, "signInWithGithub", function () {
    return _this.auth.signInWithPopup(new _app["default"].auth.GithubAuthProvider());
  });
  ...
  _defineProperty(this, "reauthenticate", function (currentPassword) {
    var user = _this.auth.currentUser;
    var cred = _app["default"].auth.EmailAuthProvider.credential(user.email, currentPassword);
  ...
  _defineProperty(this, "setAuthPersistence", function () {
    return _this.auth.setPersistence(_app["default"].auth.Auth.Persistence.LOCAL);
  });
  // // PRODUCT ACTIONS --------------
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              query = _this.db.collection("products").orderBy(_app["default"].firestore.FieldPath.documentId()).startAfter(lastRefKey).limit(12);
              _context.next = 5;
              return query.get();
            case 5:
            ...
            case 21:
              ...
              _query = _this.db.collection("products").orderBy(_app["default"].firestore.FieldPath.documentId()).limit(12);
              _context.next = 26;
              return _query.get();
            case 26:
