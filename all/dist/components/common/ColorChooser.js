...
ColorChooser.propTypes = {
  availableColors: _propTypes["default"].arrayOf(_propTypes["default"].string).isRequired,
  onSelectedColorChange: _propTypes["default"].func.isRequired
};
var _default = ColorChooser;
