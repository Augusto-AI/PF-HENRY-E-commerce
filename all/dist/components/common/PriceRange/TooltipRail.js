...
var TooltipRail = /*#__PURE__*/function (_Component) {
  _inherits(TooltipRail, _Component);
  var _super = _createSuper(TooltipRail);
  function TooltipRail(props) {
    var _this;
    _classCallCheck(this, TooltipRail);
  ...
  _createClass(TooltipRail, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, !activeHandleID && value ? /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          left: "".concat(percent, "%"),
          position: 'absolute',
          marginLeft: '-11px',
